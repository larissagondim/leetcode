...
- `normal-problems/` - python (and sometimes C) solution for common problems;
...
| Problem No. | Problem Title | Language(s) | File |
|-------------|---------------|-------------|------|
...
| 1137 | [N-th Tribonacci Number](https://leetcode.com/problems/n-th-tribonacci-number/) | Python | [nth-tribonacci-number.py](normal-problems/nth-tribonacci-number.py) |
...
|-------------|---------------|----------|------|
| 704 | [Binary Search](https://leetcode.com/problems/binary-search/description/) | Python | [binary-search.py](algorithms/binary-search.py) |
